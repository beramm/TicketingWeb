        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <form action="/profile/visitors" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row mt-3">
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" id="nik" name="nik"
                                    required value="<?php echo e(old('nik')); ?>">
                                <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="telepon"
                                    name="telepon" required value="<?php echo e(old('telepon')); ?>">
                                <?php $__errorArgs = ['nama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    id="kelahiran" name="kelahiran" required value="<?php echo e(old('kelahiran')); ?>">
...
<?php echo $__env->make('profile.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\app\TicketingWeb\Ticketing\resources\views/profile/visitors/create.blade.php ENDPATH**/ ?>