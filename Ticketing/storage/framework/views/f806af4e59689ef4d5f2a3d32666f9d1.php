...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-lg-8 mb-5">
        <form method="POST" action="/dashboard/tickets/<?php echo e($ticket->id); ?>">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="concerts_id" required>
                    <?php $__currentLoopData = $concerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(old('concerts_id', $ticket->concerts_id) == $concert->id): ?>
...
unset($__errorArgs, $__bag); ?>" id="venue"
                    name="venue" required autofocus value="<?php echo e(old('venue', $ticket->venue)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                    id="harga" name="harga" required value="<?php echo e(old('harga', $ticket->harga)); ?>" min=0>
...
unset($__errorArgs, $__bag); ?>"
                    id="kuantitas" name="kuantitas" required value="<?php echo e(old('kuantitas', $ticket->kuantitas)); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\app\TicketingWeb\Ticketing\resources\views/dashboard/tickets/edit.blade.php ENDPATH**/ ?>