            ...
            <form action="/postRegister" class="form" id="form1" method="POST">
                ...
                <div>
                    <input type="text" name="name" placeholder="name"
                        class="input form-control @error('name') is-invalid @enderror" id="name" required
                        value="{{ old('name') }}" />
                    @error('name')
                ...
                <div>
                    <input type="email" placeholder="email" name="email"
                        class="input form-control @error('email') is-invalid @enderror" id="email" required
                        value="{{ old('email') }}" />
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div>
                    <input type="password" placeholder="password" name="password"
                        class="input form-control @error('password') is-invalid @enderror" id="password" required
                        value="{{ old('password') }}" />
                    @error('password')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                {{-- <input type="password" placeholder="confirm" class="input" /> --}}
